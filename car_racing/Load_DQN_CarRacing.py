...
TARGET_REPLACE_ITER = 600   # target update frequency
...
num = '1780'
dqn.eval_net.load_state_dict(torch.load("./save/model/"+num+"_eval_net_params.pkl"))
dqn.target_net.load_state_dict(torch.load("./save/model/"+num+"_target_net_params.pkl"))
dqn.memory = np.load("./save/model/"+num+"_dqn.memory.npy")
